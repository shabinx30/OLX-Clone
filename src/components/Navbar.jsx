    ...
    <div className="h-[4.2em] w-full flex bg-gray-100 pt-[10px] px-4 justify-between fixed">
      ...
      <div className="pl-4 hidden md:flex">
        ...
        <div className="border-2 h-12 bg-white border-black rounded-md w-[50em] ml-4 flex">
          ...
          <IoIosSearch size={20} className="text-white bg-[#002f34] h-full w-full rounded-sm p-2" />
        </div>
      </div>
      <Language />
      <p className="text-black font-bold text-base underline mt-2 mr-3">
        Login
      </p>
      <SellButton />
